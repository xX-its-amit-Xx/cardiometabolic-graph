...
RANGES: dict[str, MetricRange] = {
    ...
    "brier": MetricRange(
        floor=0.0, acceptable=0.20, good=0.15, ceiling=0.25,
    ...
    "ece": MetricRange(
        floor=0.0, acceptable=0.10, good=0.05, ceiling=0.30,
        higher_is_better=False,
    ...
    "capture": MetricRange(
        floor=0.10, acceptable=0.30, good=0.50, ceiling=1.0,
        higher_is_better=True,
    ...
    "psi": MetricRange(
        floor=0.0, acceptable=0.10, good=0.05, ceiling=0.25,
        higher_is_better=False,
    ...
    "completeness": MetricRange(
        floor=0.7, acceptable=0.95, good=1.0, ceiling=1.0,
        higher_is_better=True,
